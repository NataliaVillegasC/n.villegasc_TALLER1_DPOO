...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre del país que representa cierto atleta");
	...
	// - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - * - *
	// Modificación taller 1 Olímpicos
	private void ejecutarPaisdelAtleta()
	{
		System.out.println("\n" + "MODIFICACIÓN 1: País de un atleta" + "\n");

		String nombre = input("Por favor ingrese el nombre del atleta que desea consultar");
		String Paisdelatleta = calculadora.buscarPaisAtleta(nombre);
	...
	/**
	 * Este método le pide al usuario el nombre de un atleta, para luego buscar la información 
	 * correspondiente a este y retornar el país al cual representa.
	 */
